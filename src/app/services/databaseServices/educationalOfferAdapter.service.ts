          ...
          return new LectureDB(
            {
              ...
              workloadUnit: lectureNode.workloadUnit,
          ...
          return new CourseDB(
            {
              ...
              workloadUnit: courseNode.workloadUnit,
          ...
          return new GroupingDB(
            {
              ...
              workloadUnit: groupingNode.workloadUnit,
          ...
          return new StudyProgramDB(
            {
              ...
              workloadUnit: studyProgramNode.workloadUnit,
        ...
        return new Lecture(
          {
            ...
            eqf: lectureDB.eqf,
            ects: lectureDB.ects,
            workloadUnit: lectureDB.workloadUnit,
        ...
        return new Course(
          {
            ...
            eqf: courseDB.eqf,
            ects: courseDB.ects,
            workloadUnit: courseDB.workloadUnit,
        ...
        return new Grouping(
          {
            ...
            workloadUnit: groupingDB.workloadUnit,
        ...
        return new StudyProgram(
          {
            ...
            workloadUnit: studyProgramDB.workloadUnit,
