...
export class AppComponent {
  ...
  constructor() {
    ...
    this.langChangeSub = this.translate.onLangChange.subscribe(() => this.buildMenu());
    this.buildMenu();
  }
  ...
  private buildMenu() {
    this.headerItems = [ 
      {
        label: this.translate.instant('header.nav.tools'),
        icon: 'pi pi-cog',
        items: [
          {
      ...
      {
        label: this.translate.instant('header.nav.share'),
